        ...
        <ScrollReveal variant="fade-up">
          <div id="shop" className="max-w-2xl mx-auto text-center">
            ...
            {flagship?.slug ? (
              ...
              <button
                disabled
                className="btn-interactive inline-flex items-center gap-2 bg-forest-green text-white font-semibold px-10 py-4 rounded-full text-base opacity-60 cursor-not-allowed"
              >
                View product
              </button>
            )}
