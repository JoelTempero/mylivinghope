...
Abide is a guided booklet for anyone who has felt a gap between their faith and their ordinary week. It walks you through twelve spiritual practices, the everyday rhythms Jesus lived out in the gospels. Each one is small enough to start this week.

Every practice gives you the why behind it, scripture to sit with, a simple way to begin, and honest questions to make it your own:

Solitude · Rest · Reading the Bible · Prayer · Service · Generosity · Fasting · Community · Witness · Simplicity · Worship · Stewardship

Come as you are. You can't make God love you any more than He already does, but you can grow closer to Him. Abide gives you a gentle place to start, on your own, in a youth group, or across a whole ministry.
...
export const previewProducts = [
  {
    ...
    seo: {
      ...
      description:
        'A guided booklet of 12 spiritual practices for everyday faith: solitude, prayer, rest, generosity and more. Simple ways to walk with God day to day.',
    },
    images: [
